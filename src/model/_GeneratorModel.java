...
import com.xiaomuedu.common.config.MainConfig;


public class _GeneratorModel
{
	public static DataSource getDataSource()//连接数据库
	{
	...
	public static void main(String[] args)
	{
		...
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getRootClassPath() + "/../../../src/model/base";
